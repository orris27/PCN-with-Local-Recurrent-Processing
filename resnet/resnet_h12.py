...
class ClassifierModule2(nn.Module):
    ...
    def forward(self, x_block, x_clf):
        ...
        return rep, None # None represents the hidden outputs
...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, cls=0, dropout=1.0, adaptive=False, vanilla=False, ge=False):
        ...
        self.classifiers.append(ClassifierModule(16, 0, self.clf_h[0], num_classes, self.adaptive, self.cls, self.dropout))
        self.classifiers.append(ClassifierModule(32, self.clf_h[0], self.clf_h[1], num_classes, self.adaptive, self.cls, self.dropout))
        self.classifiers.append(ClassifierModule2(64, self.clf_h[1], num_classes, self.adaptive, self.cls, self.dropout))
